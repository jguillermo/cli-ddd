...
export class ServiceMenuGraphQlRender extends AbstractServiceResponse {
  ...
  private renderFeature(aggregate: Aggregate, properties: WPropertie[], type: string) {
    ...
    const propertiesValues = properties.map((p) => {
      let valuePropertie: any = '';
      let valuePropertieUpdated = '';
      let valuePropertieCompleted = '';
      let valuePropertieUpdatedCompleted = '';
      let valueFunction = '';
      let hasQuote = true;
      switch (p.propertie.type.value) {
        case PropertieTypes.ID: {
          ...
          valuePropertieCompleted = valuePropertie;
          valuePropertieUpdatedCompleted = valuePropertie;
          valueFunction = valuePropertie;
          break;
        }
        case PropertieTypes.STRING: {
          ...
          valuePropertieCompleted = valuePropertie;
          valuePropertieUpdatedCompleted = valuePropertieUpdated;
          valueFunction = valuePropertie;
          break;
        }
        case PropertieTypes.UUID: {
          valuePropertie = resources.aggregateUUIDs[0];
          valuePropertieUpdated = resources.aggregateUUIDs[1];
          valuePropertieCompleted = valuePropertie;
          valuePropertieUpdatedCompleted = valuePropertieUpdated;
          valueFunction = valuePropertie;
          break;
        ...
        case PropertieTypes.DATE: {
          valuePropertie = '2018-03-23';
          valuePropertieUpdated = '2018-03-23';
          valuePropertieCompleted = '2018-03-23T00:00:00.000Z';
          valuePropertieUpdatedCompleted = '2018-03-23T00:00:00.000Z';
      ...
      return {
        ...
        completed: valuePropertieCompleted,
        completeUpdated: valuePropertieUpdatedCompleted,
        valueFunction,
        hasQuote,
      };
    });
